...
import {Modal, Box, Typography, Divider, Table, TableHead, TableBody, TableCell, TableRow, TableContainer } from "@mui/material";
...
const ThirdMonthEval = ({ userId, fName, lName, pos, open, onClose,  }) => {
  ...
  // }
  // if (!overallSelfVBPA && !overallHeadVBPA) {
