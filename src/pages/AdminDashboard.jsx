        ...
        <Grid item xs={12} md={6} lg={6}>
          <Paper
            ...
            sx={{
              padding: 1,
              borderRadius: 2,
              boxShadow: "0 10px 20px -20px rgba(253, 10, 0.9, 0.9)",
            }}
          >
            <Typography
              ...
              fontFamily="Poppins"
            >
              Evaluation Status for 3rd and 5th Month
            </Typography>
            <Box
              sx={{
                height: 150,
