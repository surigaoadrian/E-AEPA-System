...
function ManageAccount() {
	...
	const handleCheckUsername = (e) => {
		setCheckUsername(e.target.value.trim());
	};
			...
			const fetchUsername = async () => {
				try {
					const response = await axios.put(
						`http://localhost:8080/user/checkUsername/${checkUsername}`
					);
	...
	const isTaken = msgInfo === "Username already taken";
	...
	const handleCreateAccount = async (e) => {
		...
		const middleName = capitalizeFirstLetter(
		...
		<Animated>
			<div>
				<Typography
					ml={6.2}
					mt={3}
					sx={{ fontFamily: "Poppins", fontWeight: 600, fontSize: "23px" }}
				>
					User Accounts
				</Typography>
				<Box
				...
				>
					<Grid container>
						...
						<Grid item xs={12} sx={{ height: "6vh", display: "flex" }}>
							<Tabs
								value={selectedTab}
                   ...
                   top: 8,
								...
								>
									<Grid item sx={{ height: "4.1vh" }}>
										<PersonRoundedIcon
											sx={{ color: "white", fontSize: "27px", ml: 1,}}
										/>
									</Grid>
									<Grid item sx={{ fontSize: "17px", fontWeight: 500,}}>
							...
							>
								<Grid container spacing={0.1} sx={{ width: "45vh" }}>
									<Grid item xs={3} sx={{ margin: 1 }}>
										<Typography
											style={{ fontFamily: "Poppins", color: "gray" }}
										>
											User Role:{" "}
										</Typography>
									</Grid>
				...
				>
					...
					>
						<Grid container spacing={0.6}>
							<Grid item xs={12} sx={{ height: "4.1vh" }}>
								<Grid
									container
									spacing={0.5}
									sx={{
                    ...
                    alignItems:"center",
								...
								>
									<Grid item sx={{ height: "4.1vh" }}>
										<DeleteOutlineIcon
											sx={{ color: "white", fontSize: "25px", ml: 1,  }}
										/>
									</Grid>
